...
The separation process should be quite fast on a GPU (should be less than 1 min 30 on the musdb test set) but the execution of [museval](https://github.com/sigsep/sigsep-mus-eval) takes much more time (a few hours).