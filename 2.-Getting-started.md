...
* A *JSON* configuration file such as [this one](/deezer/spleeter/blob/master/configs/mudsb_config.json) that gathers all parameters needed for training and paths to *CSV* file.
