...
In order to provide abstraction for audio based I/O operation, **Spleeter** use an abstract class ``spleeter.utils.audio.adapter.AudioAdapter`` with following specification :
